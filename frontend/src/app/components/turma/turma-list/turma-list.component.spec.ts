...
// O primeiro argumento é uma descrição do que está sendo testado. O nome aqui estava 'TurmaList', mas a convenção é usar o nome do componente para clareza.
describe('TurmaListComponent', () => {
  
  // Declaração das variáveis que usaremos em nossos testes.
  let component: TurmaListComponent; // Esta variável vai armazenar a instância da nossa classe do componente.
  let fixture: ComponentFixture<TurmaListComponent>; // 'fixture' é um utilitário de teste que nos ajuda a interagir com o componente e seu template HTML.
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      // Se o componente tivesse dependências no construtor (como TurmaService ou Router), teríamos que provê-las aqui também,
